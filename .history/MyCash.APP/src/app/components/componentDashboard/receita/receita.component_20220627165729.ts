...
export class ReceitaComponent implements OnInit {
  ...
  constructor(private receitaService: ReceitaService, private categoriaReceitaService: CategoriaReceitaService) { }
  ...
  carregarSubcategoria(){
    this.carregarSubcategoriaService.GetAll().subscribe(resultado => {
      this.carregarSubcategoria = resultado;
    });
  }

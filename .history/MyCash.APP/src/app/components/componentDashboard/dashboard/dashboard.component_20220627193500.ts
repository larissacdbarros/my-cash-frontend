...
export class DashboardComponent implements OnInit {
  ...
  constructor(private receita : MatDialog, private despesa : MatDialog, private cartaocredito : MatDialog, private receitalist : MatDialog)  {
  ...
  visibilidadeTabela(visibilidadeTabela: boolean = true) {
    this.receitalist.open(ReceitalistComponent);

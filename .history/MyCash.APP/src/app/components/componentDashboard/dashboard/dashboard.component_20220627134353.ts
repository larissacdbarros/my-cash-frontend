...
export class DashboardComponent implements OnInit {
  ...
  constructor(private receita : MatDialog, private despesa : MatDialog, private cartaocredito : MatDialog, private receita-list : MatDialog)  {
  ...
  openList1() {
    this.cartaocredito.open(ReceitaListComponent);
  }
